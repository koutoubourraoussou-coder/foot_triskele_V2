...
with tab1:
    ...
    df_verdict_sys = collect_verdict_mapping("verdict_post_analyse_tickets_report.txt")
    df_verdict_rand = collect_verdict_mapping("verdict_post_analyse_tickets_o15_random_report.txt")
