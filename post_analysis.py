...
from services.post_analysis_core import (
    ...
    POST_TICKETS_O15_SUPER_VERDICT_FILE,
...
def archive_post_outputs() -> None:
    ...
    for target_date in run_dates:
        ...
        _archive_tsv_for_date(
            POST_TICKETS_O15_SUPER_VERDICT_FILE,
            archive_dir / "verdict_post_analyse_tickets_o15_super_random.txt",
            target_date,
            date_col_index=2,
        )
        ...
        _archive_tsv_for_date(
            POST_TICKETS_U35_SUPER_VERDICT_FILE,
            archive_dir / "verdict_post_analyse_tickets_u35_super_random.txt",
            target_date,
            date_col_index=2,
        )
