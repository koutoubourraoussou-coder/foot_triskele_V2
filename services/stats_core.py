...
DEFAULT_TICKETS_O15_SUPER_VERDICT_PATH = Path("data/verdict_post_analyse_tickets_o15_super_random.txt")
DEFAULT_TICKETS_U35_SUPER_VERDICT_PATH = Path("data/verdict_post_analyse_tickets_u35_super_random.txt")
...
def load_ticket_verdicts() -> pd.DataFrame:
    ...
    _load_one(DEFAULT_TICKETS_O15_SUPER_VERDICT_PATH, "O15_SUPER_RANDOM")
    _load_one(DEFAULT_TICKETS_U35_SUPER_VERDICT_PATH, "U35_SUPER_RANDOM")
