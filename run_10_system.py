"""10 runs SYSTEM SAFE — max_losses=4"""
...
def main():
    ...
    print(f"[run10] Lancement {N_RUNS} runs SYSTEM SAFE (max_losses={MAX_LOSSES})...\n")
    ...
    for run_idx in range(N_RUNS):
        ...
        r = replay_safe_quick(sys_details)
        r["run"] = run_idx + 1
        results.append(r)
        sys.stdout.write(
